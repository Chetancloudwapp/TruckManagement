            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="privacy-policy" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>S.No.</th>
                                        <th>Title</th>
                                ...
                                <tbody>
                                    @foreach($get_privacy_policy as $key => $privacy_policy)
                                    <tr>
                                        <td>{{ ++$key }}</td>
                                        <td>{{ $privacy_policy['title'] }}</td>
                                        <td>{!! $privacy_policy['description'] !!}</td>
                                        <td class="text-center">
                                            <a href="{{ url('admin/privacy-policy/edit/'. encrypt($privacy_policy['id'])) }}"> 
                                                <button class="btn btn-primary btn-sm">Edit</button>
                                            </a>
                                            {{-- <a href="javascript:void(0)" style="margin-left:0em" record="privacy-policy/delete"
                                                record_id="{{ $privacy_policy['id'] }}" class="confirmDelete" name="privacy-policy"
