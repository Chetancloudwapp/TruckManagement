            ...
            <div class="col-md-12">
               ...
               @endif
                <ul class="nav nav-tabs">
                    ...
                    {{-- <li><a data-toggle="tab" href="#end_trip">End Trip</a></li> --}}
                </ul>
                        ...
                        <div class="card">
                            ...
                            <table id="example" class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <img class="tbl-img-css rounded-circle" width="60px" height="60px" style="border-radius:50%;"
                                        {{-- src="{{ $toll['toll_image'] !='' ? asset('public/uploads/startTrip/tolls/'.$toll['toll_image']) : asset('public/uploads/placeholder/default_user.png') }}"> --}}
                                        src="{{ $toll['toll_image'] }}">
                                    </td>
                                    <td>
