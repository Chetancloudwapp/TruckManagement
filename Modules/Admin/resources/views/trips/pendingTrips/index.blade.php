                            ...
                            <table id="categories" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                $get_truck_name = Modules\Admin\app\Models\Truck::where(['id'=>$pending_trips->truck_id])->select('id','brand')->first();
                                                if(!empty($get_truck_name)){
                                                    $get_driver_name = App\Models\User::where(['id'=> $pending_trips->driver_id])->select('id','first_name','last_name')->first();
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-pill badge-warning">{{ $pending_trips['status']
                                                }}</span>
                                            @else
                                            <span class="badge badge-pill badge-success">{{ $pending_trips['status']
                                                }}</span>
                                            @endif
                                        </td>
