      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-12">
               ...
               @endif
               @if(($get_trip['status'] == 'Pending' || $get_trip['status'] == 'Accepted') || $get_trip['is_status'] == 'Accepted')
               ...
               {{-- @elseif(($get_trip['is_status'] == 'On the way' || $get_trip['is_status'] == 'Delivered') || $get_trip['status'] == 'Accepted')
                     <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#basic_detail">Basic detail</a></li>
                        ...
                        <div id="toll" class="tab-pane">
                           <div class="card">
                              <div class="card-body">
                                 <table id="example" class="table table-bordered">
                                    <tr>
                                       <th><label for="status">toll name</label></th>
                                       <th><label for="status">Amount</label></th>
                                    </tr>
                        ...
                        <div id="repair" class="tab-pane">
                           <div class="card">
                              <div class="card-body">
                                 <table id="example" class="table table-bordered">
                                    <tr>
                                       <th><label for="status">shop name</label></th>
                                       <th><label for="status">repair name</label></th>
                                       <th><label for="status">repair cost</label></th>
                                       <th><label for="status">spare name</label></th>
                                       <th><label for="status">spare cost</label></th>
                                       <th><label for="status">total amount</label></th>
                                    </tr>
                        ...
                        <div id="fines" class="tab-pane">
                           <div class="card">
                              <div class="card-body">
                                 <table id="example" class="table table-bordered">
                                    <tr>
                                       <th><label for="status">Fine Name</label></th>
                                       <th><label for="status">Amount</label></th>
                                       <th><label for="status">Description</label></th>
                                    </tr>
                        ...
                        <div id="road_accidents" class="tab-pane">
                           <div class="card">
                              <div class="card-body">
                                 <table id="example" class="table table-bordered">
                                    <tr>
                                       <th><label for="status">Accident Type </label></th>
                                       <th><label for="status">Cost  </label></th>
                                       <th><label for="status">description</label></th>
                                    </tr>
                        ...
                        <div id="other_charges" class="tab-pane">
                           <div class="card">
                              <div class="card-body">
                                 <table id="example" class="table table-bordered">
                                    <tr>
                                       <th><label for="status">Name</label></th>
                                       <th><label for="status">Amount</label></th>
                                       <th><label for="status">Description</label></th>
                                    </tr>
