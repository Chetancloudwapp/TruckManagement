                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3 {{ $errors->has('brand') ? 'has-danger' : '' }}">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('brand', $trucks['brand']) }}" placeholder="Enter brand">      
                                        @error('brand')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3 {{ $errors->has('modal') ? 'has-danger' : '' }}">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('modal', $trucks['modal']) }}" placeholder="Enter modal">      
                                        @error('modal')
                                            <div class="col-form-alert-label">
                                                {{ $message }}
                                            </div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group mb-3 {{ $errors->has('km_driven') ? 'has-danger' : '' }}">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('km_driven', $trucks['km_driven']) }}" placeholder="Enter km driven">      
                                        @error('km_driven')
                                            <div class="col-form-alert-label">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3 {{ $errors->has('next_oil_change') ? 'has-danger' : '' }}">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('next_oil_change', $trucks['next_oil_change_km']) }}" placeholder="Enter km driven">      
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3 {{ $errors->has('year') ? 'has-danger' : '' }}">
                                        ...
                                        <input
                                            ...
                                            name="year" type="text"
                                            value="{{ date('Y-m-d', strtotime($trucks['year'])) }}" placeholder="Enter year">   
                                        @error('year')
                                            <div class="col-form-alert-label">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3 {{ $errors->has('plate_number') ? 'has-danger' : '' }}">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('plate_number', $trucks['plate_number']) }}" placeholder="Enter plate number">      
                                        @error('plate_number')
                                            <div class="col-form-alert-label">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group mb-3 {{ $errors->has('status') ? 'has-danger' : '' }}">
                                        ...
                                        <select id="status" name="status" class="form-control stock">
                                            ...
                                            <option value="Deactive"
                                                {{ $trucks['status'] == 'Deactive' ? 'selected' : '' }}>Deactive
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="col-form-alert-label">
